...
func (w *USDC) IsTransactionMatch(client *ethclient.Client, url string, address string, txid string) (string, bool) {
...
func (w *USDC) GetLatestTx(client *ethclient.Client, url string, address string) (string, bool) {
